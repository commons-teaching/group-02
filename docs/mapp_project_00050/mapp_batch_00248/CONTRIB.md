...
```bash
sg commons-users -c './copy_files.sh -i /mnt/bigdata/mapp/public/QE_HFX_unifr/converted -o /msdata/mapp_project_00050/mapp_batch_00248 -p "*mapp_01_*.mzML"'
```
...
paths:
  ...
  input_folder: /Users/voletco/git_repos/group-02/docs/mapp_project_00050/mapp_batch_00248/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  ...
  output_folder: /Users/voletco/git_repos/group-02/docs/mapp_project_00050/mapp_batch_00248/results/met_annot_enhancer # the path for your output to be stored in
...
```yaml
paths:
  docs: '/Users/voletco/git_repos/group-02/docs'
  output: '/Users/voletco/git_repos/group-02/docs/mapp_project_00050/mapp_batch_00248/results/stats' # Not mandatory, default is in the stats subdirectory
