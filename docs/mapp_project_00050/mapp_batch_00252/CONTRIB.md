...
```bash
sg commons-users -c './copy_files.sh -i /mnt/bigdata/mapp/public/QE_HFX_unifr/converted -o /msdata/mapp_project_00050/mapp_batch_00252 -p "*20260428_CVOL_Group_02*.mzML"'
```

### Transfer the metadata to the msdata folder

```bash
cd ./docs/mapp_project_00050/mapp_batch_00252/
cp ./metadata/treated/mapp_batch_00252_metadata.tsv /msdata/mapp_project_00050/mapp_batch_00252/mapp_batch_00252_metadata.tsv
```
...
```bash
cd ./docs/mapp_project_00050/mapp_batch_00252/results/mzmine
```

And proceed to awk black magic to update the mzmine xml file

```bash
awk -v dir="/msdata/mapp_project_00050/mapp_batch_00252_second" '
BEGIN {
  cmd = "ls " dir "/*.mzML"
...
}' mapp_batch_00252.mzbatch_template > mapp_batch_00252.mzbatch
```
...
```bash
sg commons-users -c '/opt/mzmine/bin/mzmine -batch mapp_batch_00252.mzbatch'
```
...
```bash
taxonomical-utils resolve-taxa --input-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_metadata.tsv --output-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_metadata_resolved.csv --org-column-header source_taxon
```

2. retrieve upper taxa lineage
    
```bash
taxonomical-utils append-taxonomy --input-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_metadata_resolved.csv --output-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/metadata_upper_taxa_lineage.csv
```

3. append WD ids 

```bash
taxonomical-utils append-wd-id --input-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_metadata_resolved.csv --output-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_wd.csv
```

```bash
taxonomical-utils merge --input-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_metadata.tsv --resolved-taxa-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_metadata_resolved.csv --upper-taxa-lineage-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/metadata_upper_taxa_lineage.csv --wd-file docs/mapp_project_00050/mapp_batch_00252/metadata/original/mapp_batch_00252_wd.csv --output-file docs/mapp_project_00050/mapp_batch_00252/metadata/treated/mapp_batch_00252_metadata.tsv --org-column-header source_taxon
```
...
ssh commons-server
tmux a -t sirius
cd ~/git_repos/commons-teaching/group-02/docs/mapp_project_00050/mapp_batch_00252/results
```
...
paths:
  gnps_job_id: 8a522c9422024a008d7934e809503047 # The GNPS job id you want to treat
  input_folder: /Users/voletco/git_repos/commons-teaching/group-02/docs/mapp_project_00050/mapp_batch_00252/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  project_name: mapp_batch_00252 #ISDB_annot_LP_plantfungi_set # The name you want to give to your project, output resulst in data_out/project_name
  output_folder: /Users/voletco/git_repos/commons-teaching/group-02/docs/mapp_project_00050/mapp_batch_00252/results/met_annot_enhancer # the path for your output to be stored in
...
```bash
cd ./docs/mapp_project_00050/mapp_batch_00252
find ./results/met_annot_enhancer/8a522c9422024a008d7934e809503047 -type l -exec rm {} +
```
...
paths:
  ...
  output: '/Users/voletco/git_repos/commons-teaching/group-02/docs/mapp_project_00050/mapp_batch_00252/results/stats' # Not mandatory, default is in the stats subdirectory
...
mapp_batch : mapp_batch_00252
met_annot_enhancer_folder : mapp_batch_00252
gnps_job_id : 8a522c9422024a008d7934e809503047

dataset_experiment : 
  name: "mapp_batch_00252 LCMS metabolomics dataset"
  description: "Untargeted metabolomics, tp26 SBL. 200004, group-02 - HILIC"
...
```bash
met-annot-unifier-cli align-horizontally --canopus-file ./results/sirius/canopus_structure_summary.tsv --gnps-file ./results/met_annot_enhancer/8a522c9422024a008d7934e809503047/nf_output/library/merged_results_with_gnps.tsv --gnps-mn-file ./results/met_annot_enhancer/8a522c9422024a008d7934e809503047/nf_output/networking/clustersummary_with_network.tsv --sirius-file ./results/sirius/structure_identifications.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00252/mapp_batch_00252_spectral_match_results_repond_flat.tsv --output ./results/tmp/mapp_batch_00252_met_annot_unified_horizontal.tsv
```

#### Align vertically

```bash
met-annot-unifier-cli align-vertically  --gnps-file ./results/met_annot_enhancer/8a522c9422024a008d7934e809503047/nf_output/library/merged_results_with_gnps.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00252/mapp_batch_00252_spectral_match_results_repond_flat.tsv --sirius-file ./results/sirius/structure_identifications.tsv  --output ./results/tmp/mapp_batch_00252_met_annot_unified_vertical.tsv
```